          ...
          <div className="p-6 space-y-6">
            ...
            <section className="bg-amber-50 rounded-lg p-4 border border-amber-300">
              <h3 className="text-base font-bold text-amber-900 mb-2 flex items-center gap-2">
                ...
                Remise à zéro chaque saison
              </h3>
              <p className="text-xs text-gray-700 leading-relaxed mb-2">
                Chaque saison de rugby débute le <strong>1er août</strong>. À cette date, le compteur de <strong>points de classement</strong> revient à <strong>zéro</strong> pour tous les utilisateurs.
              </p>
              <p className="text-xs text-gray-700 leading-relaxed">
                Votre <strong>solde de jetons</strong> est conservé d'une saison à l'autre — il reflète votre cagnotte personnelle.
              </p>
            </section>
