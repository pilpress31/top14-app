              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {(() => {
                    ...
                    if (round && PLAYOFF_LABELS[round]) {
                      return <span className="font-bold text-sm" style={isD2Match ? { color: '#00174D' } : {}}>{PLAYOFF_LABELS[round]}</span>;
                    }
...
function PronoCard({ match, openPanel, onTogglePanel }) {
  ...
  return (
    <div className="w-full bg-gray-50 rounded-lg py-4 border border-gray-200">
      ...
      {/* Barre indice favori (composant partagé) */}
      <BarreIndiceFavori pct={confidencePct} variant={match.isD2 ? 'prod2' : 'top14'} />
