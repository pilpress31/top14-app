...
const NATIONS_DATA = {
  "AFRIQUE DU SUD": { logo: '/logos/RSA.svg', name: "Afrique du Sud" },
  "ALBANIE": { logo: '/logos/ALB.svg', name: "Albanie" },
  "ALGÉRIE": { logo: '/logos/ALG.svg', name: "Algérie" },
  "ALLEMAGNE": { logo: '/logos/GER.svg', name: "Allemagne" },
  "ALLEMAGNE DE L'OUEST": { logo: '/logos/WGE.svg', name: "Allemagne de l'Ouest" },
  "ANDORRE": { logo: '/logos/AND.svg', name: "Andorre" },
  "ANGLETERRE": { logo: '/logos/ENG.svg', name: "Angleterre" },
  "ARABIE SAOUDITE": { logo: '/logos/KSA.svg', name: "Arabie saoudite" },
  "ARGENTINE": { logo: '/logos/ARG.svg', name: "Argentine" },
  "ARMÉNIE": { logo: '/logos/ARM.svg', name: "Arménie" },
  "AUSTRALIE": { logo: '/logos/AUS.svg', name: "Australie" },
  "AUTRICHE": { logo: '/logos/AUT.svg', name: "Autriche" },
  "BAHAMAS": { logo: '/logos/BAH.svg', name: "Bahamas" },
  "BARBADE": { logo: '/logos/BAR.svg', name: "Barbade" },
  "BELGIQUE": { logo: '/logos/BEL.svg', name: "Belgique" },
  "BERMUDES": { logo: '/logos/BER.svg', name: "Bermudes" },
  "BOSNIE-HERZÉGOVINE": { logo: '/logos/BIH.svg', name: "Bosnie-Herzégovine" },
  "BOTSWANA": { logo: '/logos/BOT.svg', name: "Botswana" },
  "BRÉSIL": { logo: '/logos/BRA.svg', name: "Brésil" },
  "BULGARIE": { logo: '/logos/BUL.svg', name: "Bulgarie" },
  "BURKINA FASO": { logo: '/logos/BFA.svg', name: "Burkina Faso" },
  "BURUNDI": { logo: '/logos/BDI.svg', name: "Burundi" },
  "CAMEROUN": { logo: '/logos/CMR.svg', name: "Cameroun" },
  "CANADA": { logo: '/logos/CAN.svg', name: "Canada" },
  "CHILI": { logo: '/logos/CHI.svg', name: "Chili" },
  ...
  "DANEMARK": { logo: '/logos/DEN.svg', name: "Danemark" },
  "ESPAGNE": { logo: '/logos/ESP.svg', name: "Espagne" },
  "ESTONIE": { logo: '/logos/EST.svg', name: "Estonie" },
  "ESWATINI": { logo: '/logos/SWZ.svg', name: "Eswatini" },
  "FIDJI": { logo: '/logos/FIJ.svg', name: "Fidji" },
  "FINLANDE": { logo: '/logos/FIN.svg', name: "Finlande" },
  "FRANCE": { logo: '/logos/FRA.svg', name: "France" },
  "GHANA": { logo: '/logos/GHA.svg', name: "Ghana" },
  "GIBRALTAR": { logo: '/logos/GIB.svg', name: "Gibraltar" },
  "GOLFE ARABIQUE": { logo: '/logos/KRA.svg', name: "Golfe Arabique" },
  "GRÈCE": { logo: '/logos/GRE.svg', name: "Grèce" },
  "GUAM": { logo: '/logos/GUM.svg', name: "Guam" },
  "GUATEMALA": { logo: '/logos/GUA.svg', name: "Guatemala" },
  "GUYANA": { logo: '/logos/GUY.svg', name: "Guyana" },
  "GÉORGIE": { logo: '/logos/GEO.svg', name: "Géorgie" },
  "HONG KONG": { logo: '/logos/HKG.svg', name: "Hong Kong" },
  "HONGRIE": { logo: '/logos/HUN.svg', name: "Hongrie" },
  "INDE": { logo: '/logos/IND.svg', name: "Inde" },
  "INDONÉSIE": { logo: '/logos/INA.svg', name: "Indonésie" },
  "IRAN": { logo: '/logos/IRN.svg', name: "Iran" },
  "IRLANDE": { logo: '/logos/IRE.svg', name: "Irlande" },
  "ISRAËL": { logo: '/logos/ISR.svg', name: "Israël" },
  "ITALIE": { logo: '/logos/ITA.svg', name: "Italie" },
  "JAMAÏQUE": { logo: '/logos/JAM.svg', name: "Jamaïque" },
  "JAPON": { logo: '/logos/JPN.svg', name: "Japon" },
  "KAZAKHSTAN": { logo: '/logos/KAZ.svg', name: "Kazakhstan" },
  "KENYA": { logo: '/logos/KEN.svg', name: "Kenya" },
  "KIRIBATI": { logo: '/logos/KIR.svg', name: "Kiribati" },
  "KOSOVO": { logo: '/logos/KOS.svg', name: "Kosovo" },
  "LETTONIE": { logo: '/logos/LAT.svg', name: "Lettonie" },
  "LITUANIE": { logo: '/logos/LIT.svg', name: "Lituanie" },
  "LUXEMBOURG": { logo: '/logos/LUX.svg', name: "Luxembourg" },
  "MACÉDOINE DU NORD": { logo: '/logos/MKD.svg', name: "Macédoine du Nord" },
  "MADAGASCAR": { logo: '/logos/MAD.svg', name: "Madagascar" },
  "MALAISIE": { logo: '/logos/MAS.svg', name: "Malaisie" },
  "MALTE": { logo: '/logos/MLT.svg', name: "Malte" },
  "MAROC": { logo: '/logos/MAR.svg', name: "Maroc" },
  "MAURICE": { logo: '/logos/MRI.svg', name: "Maurice" },
  "MEXIQUE": { logo: '/logos/MEX.svg', name: "Mexique" },
  "MOLDAVIE": { logo: '/logos/MDA.svg', name: "Moldavie" },
  "MONACO": { logo: '/logos/MON.svg', name: "Monaco" },
  "MONTÉNÉGRO": { logo: '/logos/MNE.svg', name: "Monténégro" },
  "NAMIBIE": { logo: '/logos/NAM.svg', name: "Namibie" },
  "NAURU": { logo: '/logos/NRU.svg', name: "Nauru" },
  "NIGÉRIA": { logo: '/logos/NGR.svg', name: "Nigéria" },
  "NIUE": { logo: '/logos/NIU.svg', name: "Niue" },
  "NORVÈGE": { logo: '/logos/NOR.svg', name: "Norvège" },
  "NOUVELLE-ZÉLANDE": { logo: '/logos/NZL.svg', name: "Nouvelle-Zélande" },
  "OUGANDA": { logo: '/logos/UGA.svg', name: "Ouganda" },
  "OUZBÉKISTAN": { logo: '/logos/UZB.svg', name: "Ouzbékistan" },
  "PAKISTAN": { logo: '/logos/PAK.svg', name: "Pakistan" },
  "PANAMA": { logo: '/logos/PAN.svg', name: "Panama" },
  "PAPOUASIE-NOUVELLE-GUINÉE": { logo: '/logos/PNG.svg', name: "Papouasie-Nouvelle-Guinée" },
  "PARAGUAY": { logo: '/logos/PAR.svg', name: "Paraguay" },
  "PAYS DE GALLES": { logo: '/logos/WAL.svg', name: "Pays de Galles" },
  "PAYS-BAS": { logo: '/logos/NED.svg', name: "Pays-Bas" },
  "PHILIPPINES": { logo: '/logos/PHI.svg', name: "Philippines" },
  "POLOGNE": { logo: '/logos/POL.svg', name: "Pologne" },
  "PORTUGAL": { logo: '/logos/POR.svg', name: "Portugal" },
  "PÉROU": { logo: '/logos/PER.svg', name: "Pérou" },
  "QATAR": { logo: '/logos/QAT.svg', name: "Qatar" },
  "ROUMANIE": { logo: '/logos/ROU.svg', name: "Roumanie" },
  "RUSSIE": { logo: '/logos/RUS.svg', name: "Russie" },
  "RÉPUBLIQUE TCHÈQUE": { logo: '/logos/CZE.svg', name: "République tchèque" },
  "SAINT-VINCENT-ET-LES-GRENADINES": { logo: '/logos/VIN.svg', name: "Saint-Vincent-et-les-Grenadines" },
  "SAINTE-LUCIE": { logo: '/logos/LCA.svg', name: "Sainte-Lucie" },
  "SAMOA": { logo: '/logos/SAM.svg', name: "Samoa" },
  "SERBIE": { logo: '/logos/SRB.svg', name: "Serbie" },
  "SERBIE-ET-MONTÉNÉGRO": { logo: '/logos/SCG.svg', name: "Serbie-et-Monténégro" },
  "SINGAPOUR": { logo: '/logos/SGP.svg', name: "Singapour" },
  "SLOVAQUIE": { logo: '/logos/SVK.svg', name: "Slovaquie" },
  "SLOVÉNIE": { logo: '/logos/SVN.svg', name: "Slovénie" },
  "SRI LANKA": { logo: '/logos/SRI.svg', name: "Sri Lanka" },
  "SUISSE": { logo: '/logos/SUI.svg', name: "Suisse" },
  "SURINAME": { logo: '/logos/SUR.svg', name: "Suriname" },
  "SUÈDE": { logo: '/logos/SWE.svg', name: "Suède" },
  "SWAZILAND": { logo: '/logos/SWZ.svg', name: "Swaziland" },
  "SÉNÉGAL": { logo: '/logos/SEN.svg', name: "Sénégal" },
  "TAHITI": { logo: '/logos/TAH.svg', name: "Tahiti" },
  "TAIPEI CHINOIS": { logo: '/logos/TPE.svg', name: "Taipei chinois" },
  "TANZANIE": { logo: '/logos/TAN.svg', name: "Tanzanie" },
  "TAÏWAN": { logo: '/logos/TPE.svg', name: "Taïwan" },
  "TCHÉCOSLOVAQUIE": { logo: '/logos/TCH.svg', name: "Tchécoslovaquie" },
  "THAÏLANDE": { logo: '/logos/THA.svg', name: "Thaïlande" },
  "TONGA": { logo: '/logos/TON.svg', name: "Tonga" },
  "TRINITÉ-ET-TOBAGO": { logo: '/logos/TTO.svg', name: "Trinité-et-Tobago" },
  "TUNISIE": { logo: '/logos/TUN.svg', name: "Tunisie" },
  "TURQUIE": { logo: '/logos/TUR.svg', name: "Turquie" },
  "TUVALU": { logo: '/logos/TUV.svg', name: "Tuvalu" },
  "UKRAINE": { logo: '/logos/UKR.svg', name: "Ukraine" },
  "UNION SOVIÉTIQUE": { logo: '/logos/URS.svg', name: "Union soviétique" },
  "URSS": { logo: '/logos/URS.svg', name: "URSS" },
  "URUGUAY": { logo: '/logos/URU.svg', name: "Uruguay" },
  "VANUATU": { logo: '/logos/VAN.svg', name: "Vanuatu" },
  "VENEZUELA": { logo: '/logos/VEN.svg', name: "Venezuela" },
  "YOUGOSLAVIE": { logo: '/logos/YUG.svg', name: "Yougoslavie" },
  "ZAMBIE": { logo: '/logos/ZAM.svg', name: "Zambie" },
  "ZAÏRE": { logo: '/logos/ZAI.svg', name: "Zaïre" },
  "ZIMBABWE": { logo: '/logos/ZIM.svg', name: "Zimbabwe" },
  "ÉCOSSE": { logo: '/logos/SCO.svg', name: "Écosse" },
  "ÉMIRATS ARABES UNIS": { logo: '/logos/UAE.svg', name: "Émirats arabes unis" },
  "ÉQUATEUR": { logo: '/logos/ECU.svg', name: "Équateur" },
  "ÉTATS-UNIS": { logo: '/logos/USA.svg', name: "États-Unis" },
};
