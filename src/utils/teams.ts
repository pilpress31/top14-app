...
export const TEAMS_DATA = {
  ...
  // ════════════════════════════════════════════════════════════
  //  FINALISTES HISTORIQUES 2e DIVISION
  ...
  'LOMBEZ SAMATAN CLUB':           { logo: '/logos/lombez_samatan.svg', name: 'Lombez Samatan' },
  'PARIS UNIVERSITÉ CLUB':         { logo: '/logos/paris_uc.svg', name: 'Paris UC' },
  'RC CHALON':                     { logo: '/logos/rc_chalon.svg', name: 'RC Chalon' },
  'RC RIOM':                       { logo: '/logos/rc_riom.svg', name: 'RC Riom' },
  'RO CASTELNAUDARY':              { logo: '/logos/ro_castelnaudary.svg', name: 'RO Castelnaudary' },
  'SA MAULÉON':                    { logo: '/logos/sa_mauleon.svg', name: 'SA Mauléon' },
  'SA SAINT-SEVER':                { logo: '/logos/sa_saint_sever.svg', name: 'SA Saint-Sever' },
  'SAINT-GIRONS SC':               { logo: '/logos/saint_girons_sc.svg', name: 'Saint-Girons SC' },
  'SC PAMIERS':                    { logo: '/logos/sc_pamiers.svg', name: 'SC Pamiers' },
  'SC RIEUMES':                    { logo: '/logos/sc_rieumes.svg', name: 'SC Rieumes' },
  'SC TULLE':                      { logo: '/logos/sc_tulle.svg', name: 'SC Tulle' },
  'STADE BAGNÉRAIS':               { logo: '/logos/stade_bagnerais.svg', name: 'Stade Bagnérais' },
  'STADE FOYEN':                   { logo: '/logos/stade_foyen.svg', name: 'Stade Foyen' },
  'STADE HENDAYAIS':               { logo: '/logos/stade_hendayais.svg', name: 'Stade Hendayais' },
  'UA GUJAN-MESTRAS':              { logo: '/logos/ua_gujan_mestras.svg', name: 'UA Gujan-Mestras' },
  'UNION SIGEAN PORT-LA-NOUVELLE': { logo: '/logos/union_sigean.svg', name: 'Union Sigean' },
  'US BELLEGARDE-COUPY':           { logo: '/logos/us_bellegarde_coupy.svg', name: 'US Bellegarde-Coupy' },
  'US FOIX':                       { logo: '/logos/us_foix.svg', name: 'US Foix' },
  'US LA SEYNE':                   { logo: '/logos/us_la_seyne.svg', name: 'US La Seyne' },
  'US MARMANDE':                   { logo: '/logos/us_marmande.svg', name: 'US Marmande' },
  'VALENCE SPORTIF':               { logo: '/logos/valence_sportif.svg', name: 'Valence Sportif' },
...
export const NATIONS_DATA = {
  "AFRIQUE DU SUD": { logo: "/logos/AFRIQUE DU SUD.svg", name: "Afrique du Sud" },
  "ALBANIE": { logo: "/logos/ALBANIE.svg", name: "Albanie" },
  "ALGÉRIE": { logo: "/logos/ALGÉRIE.svg", name: "Algérie" },
  "ALLEMAGNE": { logo: "/logos/ALLEMAGNE.svg", name: "Allemagne" },
  "ALLEMAGNE DE L'OUEST": { logo: "/logos/ALLEMAGNE DE L'OUEST.svg", name: "Allemagne de l'Ouest" },
  "ANDORRE": { logo: "/logos/ANDORRE.svg", name: "Andorre" },
  "ANGLETERRE": { logo: "/logos/ANGLETERRE.svg", name: "Angleterre" },
  "ARABIE SAOUDITE": { logo: "/logos/ARABIE SAOUDITE.svg", name: "Arabie saoudite" },
  "ARGENTINE": { logo: "/logos/ARGENTINE.svg", name: "Argentine" },
  "ARMÉNIE": { logo: "/logos/ARMÉNIE.svg", name: "Arménie" },
  "AUSTRALIE": { logo: "/logos/AUSTRALIE.svg", name: "Australie" },
  "AUTRICHE": { logo: "/logos/AUTRICHE.svg", name: "Autriche" },
  "BAHAMAS": { logo: "/logos/BAHAMAS.svg", name: "Bahamas" },
  "BARBADE": { logo: "/logos/BARBADE.svg", name: "Barbade" },
  "BELGIQUE": { logo: "/logos/BELGIQUE.svg", name: "Belgique" },
  "BERMUDES": { logo: "/logos/BERMUDES.svg", name: "Bermudes" },
  "BOSNIE-HERZÉGOVINE": { logo: "/logos/BOSNIE-HERZÉGOVINE.svg", name: "Bosnie-Herzégovine" },
  "BOTSWANA": { logo: "/logos/BOTSWANA.svg", name: "Botswana" },
  "BRÉSIL": { logo: "/logos/BRÉSIL.svg", name: "Brésil" },
  "BULGARIE": { logo: "/logos/BULGARIE.svg", name: "Bulgarie" },
  "BURKINA FASO": { logo: "/logos/BURKINA FASO.svg", name: "Burkina Faso" },
  "BURUNDI": { logo: "/logos/BURUNDI.svg", name: "Burundi" },
  "CAMEROUN": { logo: "/logos/CAMEROUN.svg", name: "Cameroun" },
  "CANADA": { logo: "/logos/CANADA.svg", name: "Canada" },
  "CHILI": { logo: "/logos/CHILI.svg", name: "Chili" },
  "CHINE": { logo: "/logos/CHINE.svg", name: "Chine" },
  "CHYPRE": { logo: "/logos/CHYPRE.svg", name: "Chypre" },
  "COLOMBIE": { logo: "/logos/COLOMBIE.svg", name: "Colombie" },
  "CORÉE DU SUD": { logo: "/logos/CORÉE DU SUD.svg", name: "Corée du Sud" },
  "COSTA RICA": { logo: "/logos/COSTA RICA.svg", name: "Costa Rica" },
  "CROATIE": { logo: "/logos/CROATIE.svg", name: "Croatie" },
  "CÔTE D'IVOIRE": { logo: "/logos/CÔTE D'IVOIRE.svg", name: "Côte d'Ivoire" },
  "DANEMARK": { logo: "/logos/DANEMARK.svg", name: "Danemark" },
  "ESPAGNE": { logo: "/logos/ESPAGNE.svg", name: "Espagne" },
  "ESTONIE": { logo: "/logos/ESTONIE.svg", name: "Estonie" },
  "ESWATINI": { logo: "/logos/ESWATINI.svg", name: "Eswatini" },
  "FIDJI": { logo: "/logos/FIDJI.svg", name: "Fidji" },
  "FINLANDE": { logo: "/logos/FINLANDE.svg", name: "Finlande" },
  "FRANCE": { logo: "/logos/FRANCE.svg", name: "France" },
  "GHANA": { logo: "/logos/GHANA.svg", name: "Ghana" },
  "GIBRALTAR": { logo: "/logos/GIBRALTAR.svg", name: "Gibraltar" },
  "GOLFE ARABIQUE": { logo: "/logos/GOLFE ARABIQUE.svg", name: "Golfe Arabique" },
  "GRÈCE": { logo: "/logos/GRÈCE.svg", name: "Grèce" },
  "GUAM": { logo: "/logos/GUAM.svg", name: "Guam" },
  "GUATEMALA": { logo: "/logos/GUATEMALA.svg", name: "Guatemala" },
  "GUYANA": { logo: "/logos/GUYANA.svg", name: "Guyana" },
  "GÉORGIE": { logo: "/logos/GÉORGIE.svg", name: "Géorgie" },
  "HONG KONG": { logo: "/logos/HONG KONG.svg", name: "Hong Kong" },
  "HONGRIE": { logo: "/logos/HONGRIE.svg", name: "Hongrie" },
  "INDE": { logo: "/logos/INDE.svg", name: "Inde" },
  "INDONÉSIE": { logo: "/logos/INDONÉSIE.svg", name: "Indonésie" },
  "IRAN": { logo: "/logos/IRAN.svg", name: "Iran" },
  "IRLANDE": { logo: "/logos/IRLANDE.svg", name: "Irlande" },
  "ISRAËL": { logo: "/logos/ISRAËL.svg", name: "Israël" },
  "ITALIE": { logo: "/logos/ITALIE.svg", name: "Italie" },
  "JAMAÏQUE": { logo: "/logos/JAMAÏQUE.svg", name: "Jamaïque" },
  "JAPON": { logo: "/logos/JAPON.svg", name: "Japon" },
  "KAZAKHSTAN": { logo: "/logos/KAZAKHSTAN.svg", name: "Kazakhstan" },
  "KENYA": { logo: "/logos/KENYA.svg", name: "Kenya" },
  "KIRIBATI": { logo: "/logos/KIRIBATI.svg", name: "Kiribati" },
  "KOSOVO": { logo: "/logos/KOSOVO.svg", name: "Kosovo" },
  "LETTONIE": { logo: "/logos/LETTONIE.svg", name: "Lettonie" },
  "LITUANIE": { logo: "/logos/LITUANIE.svg", name: "Lituanie" },
  "LUXEMBOURG": { logo: "/logos/LUXEMBOURG.svg", name: "Luxembourg" },
  "MACÉDOINE DU NORD": { logo: "/logos/MACÉDOINE DU NORD.svg", name: "Macédoine du Nord" },
  "MADAGASCAR": { logo: "/logos/MADAGASCAR.svg", name: "Madagascar" },
  "MALAISIE": { logo: "/logos/MALAISIE.svg", name: "Malaisie" },
  "MALTE": { logo: "/logos/MALTE.svg", name: "Malte" },
  "MAROC": { logo: "/logos/MAROC.svg", name: "Maroc" },
  "MAURICE": { logo: "/logos/MAURICE.svg", name: "Maurice" },
  "MEXIQUE": { logo: "/logos/MEXIQUE.svg", name: "Mexique" },
  "MOLDAVIE": { logo: "/logos/MOLDAVIE.svg", name: "Moldavie" },
  "MONACO": { logo: "/logos/MONACO.svg", name: "Monaco" },
  "MONTÉNÉGRO": { logo: "/logos/MONTÉNÉGRO.svg", name: "Monténégro" },
  "NAMIBIE": { logo: "/logos/NAMIBIE.svg", name: "Namibie" },
  "NAURU": { logo: "/logos/NAURU.svg", name: "Nauru" },
  "NIGÉRIA": { logo: "/logos/NIGÉRIA.svg", name: "Nigéria" },
  "NIUE": { logo: "/logos/NIUE.svg", name: "Niue" },
  "NORVÈGE": { logo: "/logos/NORVÈGE.svg", name: "Norvège" },
  "NOUVELLE-ZÉLANDE": { logo: "/logos/NOUVELLE-ZÉLANDE.svg", name: "Nouvelle-Zélande" },
  "OUGANDA": { logo: "/logos/OUGANDA.svg", name: "Ouganda" },
  "OUZBÉKISTAN": { logo: "/logos/OUZBÉKISTAN.svg", name: "Ouzbékistan" },
  "PAKISTAN": { logo: "/logos/PAKISTAN.svg", name: "Pakistan" },
  "PANAMA": { logo: "/logos/PANAMA.svg", name: "Panama" },
  "PAPOUASIE-NOUVELLE-GUINÉE": { logo: "/logos/PAPOUASIE-NOUVELLE-GUINÉE.svg", name: "Papouasie-Nouvelle-Guinée" },
  "PARAGUAY": { logo: "/logos/PARAGUAY.svg", name: "Paraguay" },
  "PAYS DE GALLES": { logo: "/logos/PAYS DE GALLES.svg", name: "Pays de Galles" },
  "PAYS-BAS": { logo: "/logos/PAYS-BAS.svg", name: "Pays-Bas" },
  "PHILIPPINES": { logo: "/logos/PHILIPPINES.svg", name: "Philippines" },
  "POLOGNE": { logo: "/logos/POLOGNE.svg", name: "Pologne" },
  "PORTUGAL": { logo: "/logos/PORTUGAL.svg", name: "Portugal" },
  "PÉROU": { logo: "/logos/PÉROU.svg", name: "Pérou" },
  "QATAR": { logo: "/logos/QATAR.svg", name: "Qatar" },
  "ROUMANIE": { logo: "/logos/ROUMANIE.svg", name: "Roumanie" },
  "RUSSIE": { logo: "/logos/RUSSIE.svg", name: "Russie" },
  "RÉPUBLIQUE TCHÈQUE": { logo: "/logos/RÉPUBLIQUE TCHÈQUE.svg", name: "République tchèque" },
  "SAINT-VINCENT-ET-LES-GRENADINES": { logo: "/logos/SAINT-VINCENT-ET-LES-GRENADINES.svg", name: "Saint-Vincent-et-les-Grenadines" },
  "SAINTE-LUCIE": { logo: "/logos/SAINTE-LUCIE.svg", name: "Sainte-Lucie" },
  "SAMOA": { logo: "/logos/SAMOA.svg", name: "Samoa" },
  "SERBIE": { logo: "/logos/SERBIE.svg", name: "Serbie" },
  "SERBIE-ET-MONTÉNÉGRO": { logo: "/logos/SERBIE-ET-MONTÉNÉGRO.svg", name: "Serbie-et-Monténégro" },
  "SINGAPOUR": { logo: "/logos/SINGAPOUR.svg", name: "Singapour" },
  "SLOVAQUIE": { logo: "/logos/SLOVAQUIE.svg", name: "Slovaquie" },
  "SLOVÉNIE": { logo: "/logos/SLOVÉNIE.svg", name: "Slovénie" },
  "SRI LANKA": { logo: "/logos/SRI LANKA.svg", name: "Sri Lanka" },
  "SUISSE": { logo: "/logos/SUISSE.svg", name: "Suisse" },
  "SURINAME": { logo: "/logos/SURINAME.svg", name: "Suriname" },
  "SUÈDE": { logo: "/logos/SUÈDE.svg", name: "Suède" },
  "SWAZILAND": { logo: "/logos/SWAZILAND.svg", name: "Swaziland" },
  "SÉNÉGAL": { logo: "/logos/SÉNÉGAL.svg", name: "Sénégal" },
  "TAHITI": { logo: "/logos/TAHITI.svg", name: "Tahiti" },
  "TAIPEI CHINOIS": { logo: "/logos/TAIPEI CHINOIS.svg", name: "Taipei chinois" },
  "TANZANIE": { logo: "/logos/TANZANIE.svg", name: "Tanzanie" },
  "TAÏWAN": { logo: "/logos/TAÏWAN.svg", name: "Taïwan" },
  "TCHÉCOSLOVAQUIE": { logo: "/logos/TCHÉCOSLOVAQUIE.svg", name: "Tchécoslovaquie" },
  "THAÏLANDE": { logo: "/logos/THAÏLANDE.svg", name: "Thaïlande" },
  "TONGA": { logo: "/logos/TONGA.svg", name: "Tonga" },
  "TRINITÉ-ET-TOBAGO": { logo: "/logos/TRINITÉ-ET-TOBAGO.svg", name: "Trinité-et-Tobago" },
  "TUNISIE": { logo: "/logos/TUNISIE.svg", name: "Tunisie" },
  "TURQUIE": { logo: "/logos/TURQUIE.svg", name: "Turquie" },
  "TUVALU": { logo: "/logos/TUVALU.svg", name: "Tuvalu" },
  "UKRAINE": { logo: "/logos/UKRAINE.svg", name: "Ukraine" },
  "UNION SOVIÉTIQUE": { logo: "/logos/UNION SOVIÉTIQUE.svg", name: "Union soviétique" },
  "URSS": { logo: "/logos/URSS.svg", name: "URSS" },
  "URUGUAY": { logo: "/logos/URUGUAY.svg", name: "Uruguay" },
  "VANUATU": { logo: "/logos/VANUATU.svg", name: "Vanuatu" },
  "VENEZUELA": { logo: "/logos/VENEZUELA.svg", name: "Venezuela" },
  "YOUGOSLAVIE": { logo: "/logos/YOUGOSLAVIE.svg", name: "Yougoslavie" },
  "ZAMBIE": { logo: "/logos/ZAMBIE.svg", name: "Zambie" },
  "ZAÏRE": { logo: "/logos/ZAÏRE.svg", name: "Zaïre" },
  "ZIMBABWE": { logo: "/logos/ZIMBABWE.svg", name: "Zimbabwe" },
  "ÉCOSSE": { logo: "/logos/ÉCOSSE.svg", name: "Écosse" },
  "ÉMIRATS ARABES UNIS": { logo: "/logos/ÉMIRATS ARABES UNIS.svg", name: "Émirats arabes unis" },
  "ÉQUATEUR": { logo: "/logos/ÉQUATEUR.svg", name: "Équateur" },
  "ÉTATS-UNIS": { logo: "/logos/ÉTATS-UNIS.svg", name: "États-Unis" },



  // ── ECC : 58 clubs historiques / 2e rang absents de teams.ts ──
  'AA COIMBRA': { logo: '/logos/aa-coimbra.svg', name: 'AA Coimbra' },
  'ABERAVON': { logo: '/logos/aberavon.svg', name: 'Aberavon' },
  'BEDFORD BLUES': { logo: '/logos/bedford-blues.svg', name: 'Bedford Blues' },
  'BLACK LION': { logo: '/logos/black-lion.svg', name: 'Black Lion' },
  'BOLOGNA': { logo: '/logos/bologna.svg', name: 'Bologna' },
  'BORDERS': { logo: '/logos/borders.svg', name: 'Borders' },
  'BUCUREȘTI': { logo: '/logos/bucuresti.svg', name: 'București' },
  'BUCUREȘTI WOLVES': { logo: '/logos/bucuresti-wolves.svg', name: 'București Wolves' },
  'CAERPHILLY': { logo: '/logos/caerphilly.svg', name: 'Caerphilly' },
  'CATANIA': { logo: '/logos/catania.svg', name: 'Catania' },
  'CAVALIERI PRATO': { logo: '/logos/cavalieri-prato.svg', name: 'Cavalieri Prato' },
  'CHEETAHS': { logo: '/logos/cheetahs.svg', name: 'Cheetahs' },
  'CROCIATI PARMA': { logo: '/logos/crociati-parma.svg', name: 'Crociati Parma' },
  'CROSS KEYS': { logo: '/logos/cross-keys.svg', name: 'Cross Keys' },
  'CSM BAIA MARE': { logo: '/logos/csm-baia-mare.svg', name: 'CSM Baia Mare' },
  'DINAMO BUCUREȘTI': { logo: '/logos/dinamo-bucuresti.svg', name: 'Dinamo București' },
  'DUNVANT': { logo: '/logos/dunvant.svg', name: 'Dunvant' },
  'EL SALVADOR': { logo: '/logos/el-salvador.svg', name: 'El Salvador' },
  'ENISEY-STM': { logo: '/logos/enisey-stm.svg', name: 'Enisey-STM' },
  'FARUL CONSTANŢA': { logo: '/logos/farul-constanta.svg', name: 'Farul Constanţa' },
  'GERNIKA': { logo: '/logos/gernika.svg', name: 'Gernika' },
  'GRAN PARMA': { logo: '/logos/gran-parma.svg', name: 'Gran Parma' },
  'HEIDELBERGER RK': { logo: '/logos/heidelberger-rk.svg', name: 'Heidelberger RK' },
  'KRASNY YAR': { logo: '/logos/krasny-yar.svg', name: 'Krasny Yar' },
  'L\'AQUILA': { logo: '/logos/l-aquila.svg', name: 'L\'Aquila' },
  'LA MORALEJA': { logo: '/logos/la-moraleja.svg', name: 'La Moraleja' },
  'LA VILA': { logo: '/logos/la-vila.svg', name: 'La Vila' },
  'LEONESSA': { logo: '/logos/leonessa.svg', name: 'Leonessa' },
  'LIONS': { logo: '/logos/lions.svg', name: 'Lions' },
  'LONDON WELSH': { logo: '/logos/london-welsh.svg', name: 'London Welsh' },
  'LUSITANOS XV': { logo: '/logos/lusitanos-xv.svg', name: 'Lusitanos XV' },
  'MOGLIANO': { logo: '/logos/mogliano.svg', name: 'Mogliano' },
  'NEATH': { logo: '/logos/neath.svg', name: 'Neath' },
  'NEWBRIDGE': { logo: '/logos/newbridge.svg', name: 'Newbridge' },
  'NEWPORT': { logo: '/logos/newport.svg', name: 'Newport' },
  'OLYMPUS MADRID': { logo: '/logos/olympus-madrid.svg', name: 'Olympus Madrid' },
  'ORRELL': { logo: '/logos/orrell.svg', name: 'Orrell' },
  'OVERMACH PARMA': { logo: '/logos/overmach-parma.svg', name: 'Overmach Parma' },
  'PETRARCA PADOVA': { logo: '/logos/petrarca-padova.svg', name: 'Petrarca Padova' },
  'PIACENZA': { logo: '/logos/piacenza.svg', name: 'Piacenza' },
  'PONTYPRIDD': { logo: '/logos/pontypridd.svg', name: 'Pontypridd' },
  'PORTUGAL XV': { logo: '/logos/portugal-xv.svg', name: 'Portugal XV' },
  'RICHMOND': { logo: '/logos/richmond.svg', name: 'Richmond' },
  'ROTHERHAM': { logo: '/logos/rotherham.svg', name: 'Rotherham' },
  'ROVIGO': { logo: '/logos/rovigo.svg', name: 'Rovigo' },
  'RUGBY PARMA': { logo: '/logos/rugby-parma.svg', name: 'Rugby Parma' },
  'RUGBY ROMA': { logo: '/logos/rugby-roma.svg', name: 'Rugby Roma' },
  'RUGBY SILEA': { logo: '/logos/rugby-silea.svg', name: 'Rugby Silea' },
  'SPAIN XV': { logo: '/logos/spain-xv.svg', name: 'Spain XV' },
  'STEAUA BUCHAREST': { logo: '/logos/steaua-bucharest.svg', name: 'Steaua Bucharest' },
  'SWANSEA': { logo: '/logos/swansea.svg', name: 'Swansea' },
  'TBILISI CAUCASIANS': { logo: '/logos/tbilisi-caucasians.svg', name: 'Tbilisi Caucasians' },
  'TIMIȘOARA SARACENS': { logo: '/logos/timisoara-saracens.svg', name: 'Timișoara Saracens' },
  'TREORCHY': { logo: '/logos/treorchy.svg', name: 'Treorchy' },
  'UC MADRID': { logo: '/logos/uc-madrid.svg', name: 'UC Madrid' },
  'VALLADOLID RAC': { logo: '/logos/valladolid-rac.svg', name: 'Valladolid RAC' },
  'VIADANA': { logo: '/logos/viadana.svg', name: 'Viadana' },
  'WORCESTER WARRIORS': { logo: '/logos/worcester-warriors.svg', name: 'Worcester Warriors' },
};
...
export function getTeamData(teamName) {
  const normalizedName = teamName?.toUpperCase().trim().replace(/\u2019/g, "'");
  return TEAMS_DATA[normalizedName] || NATIONS_DATA[normalizedName] || {
